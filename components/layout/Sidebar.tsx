...
import {
  ...
  ClipboardList, Grid3X3, ChevronLeft, Sparkles, Menu, X, CalendarDays
} from 'lucide-react';
...
export function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside 
        className={`fixed left-0 top-0 h-screen bg-gray-900 text-white z-50 flex flex-col overflow-hidden transition-all duration-300
      ...
      >
        ...
        {/* Menu - Scrollable */}
        <nav className="flex-1 min-h-0 overflow-y-auto py-4 px-3 scrollbar-thin scrollbar-thumb-gray-700">
